...
import AmChart from '../../components/xray/charts/AmChart.vue'
export default {
  name: 'AmCharts',
    ...
    return {
      charts: [
        ...
        },
        {
          ...
          type: 'mixes-column',
          bodyData: {
            colors: ['#FC9F5B', '#089bab'],
            title: 'GDP growth rate',
            labels: ['GDP grow in {categoryX} (2004): [bold]{valueY}[/]', 'GDP grow in {categoryX} (2005): [bold]{valueY}[/]'],
            xAxis: ['country'],
        ...
        },
        {
          ...
          type: 'pie',
          bodyData: {
            colors: ['#089bab', '#FC9F5B', '#57de53', '#f26361', '#ababab', '#61e2fc'],
            value: ['litres'],
            category: ['country'],
            data: [
              {
