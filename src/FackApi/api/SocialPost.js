export const Posts = [
  {
    ...
    is_liked: true,
    user: {
      profile: require('../../assets/images/page-img/g1.jpg'),
      name: 'Nik Jon'
    },
    comments: [
      {
  ...
  {
    images: [require('../../assets/images/page-img/p1.jpg'), require('../../assets/images/page-img/p1.jpg'), require('../../assets/images/page-img/p1.jpg')],
    image: require('../../assets/images/page-img/p1.jpg'),
    ...
    is_commentLike: true,
    user: {
      profile: require('../../assets/images/page-img/g2.jpg'),
      name: 'John'
    },
    comments: [
      {
  ...
  },
  {
    ...
    is_commentLike: true,
    user: {
      profile: require('../../assets/images/page-img/g3.jpg'),
      name: 'Jack'
    },
    comments: [
      {
